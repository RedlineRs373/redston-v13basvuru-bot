...
client.on('clickButton', async (button) => {
  ...
  const onybuton = new disbut.MessageButton()
    ...
    .setAuthor('Xertz CluP', button.message.guild.iconURL({dynamic: true, type: 'gif', size: 1024}))

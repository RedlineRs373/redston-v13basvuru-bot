...
const fs = require("fs");//-- > Code Development: </redston> - Code Created: </xertz>
require("./util/eventLoader")(client);//-- > Code Development: </redston> - Code Created: </xertz>
require('discord-buttons')(client);

//-- > Code Development: </redston> - Code Created: </xertz>
const log = message => {
  console.log(`${message}`);
};
//-- > Code Development: </redston> - Code Created: </xertz>
...
client.on('clickButton', async (button) => {
  ...
  const onybuton = new disbut.MessageButton()
    ...
    .setAuthor('Xertz Code', button.message.guild.iconURL({dynamic: true, type: 'gif', size: 1024}))
